...
INSERT INTO match_making.roles(name, payment) VALUES
  ('Junior Developer', 1000.00)
, ('Senior Developer', 2000.00)
, ('Project Manager', 2000.00)
, ('Software Tester', 1000.00)
, ('Developer', 1500.00)
, ('UX Designer', 1000.00)
, ('Network Architect', 2000.00)
, ('Graphic Designer', 500.00)
, ('Business Analyst', 1000.00)
, ('Database Administrator', 1000.00);
...
INSERT INTO match_making.projects(name, description, project_start, estimated_end, location) VALUES
  ('Project 1', 'The first project in our system', CURDATE(), DATE_ADD(CURDATE(), INTERVAL 7 MONTH), 'Guildford')
, ('Project 2', 'The second project in our system', CURDATE(), DATE_ADD(CURDATE(), INTERVAL 17 WEEK), 'London')
, ('Project 3', 'The third project in our system', CURDATE(), DATE_ADD(CURDATE(), INTERVAL 5 MONTH), 'London')
, ('Project 4', 'The fourth project in our system', CURDATE(), DATE_ADD(CURDATE(), INTERVAL 57 DAY), 'Guildford')
, ('Project 5', 'The fifth project in our system', CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 YEAR), 'Woking');
