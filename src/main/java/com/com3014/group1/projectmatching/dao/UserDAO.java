...
public class UserDAO {
    ...
    private void getAllUsers() {
        ...
        List<UserQualification> qualifications = new ArrayList<UserQualification>();
        qualifications.add(new UserQualification("Computer Science", "Degree"));
        qualifications.add(new UserQualification("Maths", "A Level"));
        */
        ...
        user1.setAverageRating(new Float(5.0));
        /*
        ...
        */
        ...
        List<UserQualification> qualifications2 = new ArrayList<UserQualification>();
        qualifications2.add(new UserQualification("Computer Sceince", "Degree"));
        qualifications2.add(new UserQualification("Maths", "A Level"));
        */
        User user2 = new User();
        user2.setUserId(2);
        user2.setName("Fred");
        ...
        user2.setAverageRating(new Float(5.0));
        /*
